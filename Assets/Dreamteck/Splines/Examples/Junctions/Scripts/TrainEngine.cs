namespace Dreamteck.Splines.Examples
{
    ...
    public class TrainEngine : MonoBehaviour
    {
        ...
        /*private void OnJunction(List<SplineTracer.NodeConnection> passed)
        {
            ...
            if (junctionSwitch.bridge.Length == 0) return; //The JunctionSwitch does not have bridge elements
            foreach (JunctionSwitch.Bridge bridge in junctionSwitch.bridge)
            {
